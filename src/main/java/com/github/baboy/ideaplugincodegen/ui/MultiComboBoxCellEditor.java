 ...
 * @date 2023/8/3
 */
public class MultiComboBoxCellEditor extends AbstractCellEditor
    ...
    public MultiComboBoxCellEditor(final FieldComboBox multiComboBox) {
        ...
        delegate = new EditorDelegate() {
            ...
            public boolean stopCellEditing() {
                if (multiComboBox.isEditable()) {
                    // Commit edited value.
                    multiComboBox.actionPerformed(new ActionEvent(
                            MultiComboBoxCellEditor.this, 0, ""));
                }
                return super.stopCellEditing();
            }
        };
//        multiComboBox.addA.addActionListener(delegate);
    }
...
//
    ...
    protected class EditorDelegate implements ActionListener, ItemListener, Serializable {
        ...
        public void actionPerformed(ActionEvent e) {
            MultiComboBoxCellEditor.this.stopCellEditing();
        }
