 ...
 * @date 2024/3/14
 */
class SvcInterfaceGenerator:ClassGenerator() {
    companion object {
        ...
        @JvmStatic fun getFilePath(): String {
            var fp = CodeSettingCtx.svcSourceDir + "/src/main/java/" + MvcClassCtx.getSvcInterface().pkg?.replace(".", "/") + "/" + MvcClassCtx.getSvcInterface().className + ".java"
            return fp
        }
        ...
        @JvmStatic fun gen() {
            ...
            var c = TempRender.render(TempRender.TEMP_SVC_INTERFACE, data)
